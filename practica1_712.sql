...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-03-2016 a las 01:32:21
...
--
-- RELACIONES PARA LA TABLA `aficiones`:
--
...
--
-- RELACIONES PARA LA TABLA `invitacion`:
--
...
--
-- RELACIONES PARA LA TABLA `mensaje_texto`:
--
...
--
-- RELACIONES PARA LA TABLA `responden`:
--
...
--
-- RELACIONES PARA LA TABLA `solicitud_amistad`:
--
