...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-02-2016 a las 15:04:09
...
ALTER TABLE `responden`
  ADD PRIMARY KEY (`usuario`,`n_pregunta`,`n_respuesta`), ADD KEY `n_pregunta` (`n_pregunta`), ADD KEY `n_respuesta` (`n_respuesta`);

--
-- Indices de la tabla `respuestas`
--
ALTER TABLE `respuestas`
  ADD PRIMARY KEY (`numero`,`n_pregunta`), ADD KEY `n_pregunta` (`n_pregunta`);
...
ADD CONSTRAINT `responden_ibfk_2` FOREIGN KEY (`n_pregunta`) REFERENCES `respuestas` (`n_pregunta`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `responden_ibfk_3` FOREIGN KEY (`n_respuesta`) REFERENCES `respuestas` (`numero`) ON DELETE CASCADE ON UPDATE CASCADE;
