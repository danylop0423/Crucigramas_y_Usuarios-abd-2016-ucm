...
public class UsersController {
    ...
    public void gatherAllUsers() {
        ...
        Usuario u1 = new Usuario("", "", "David", "", "", new Timestamp(647418600000L), null, "", new String[0], "", "");
        Usuario u2 = new Usuario("", "", "Clara", "", "", new Timestamp(716767200000L), null, "", new String[0], "", "");
        Usuario u3 = new Usuario("", "", "Miguel", "", "", new Timestamp(697590000000L), null, "", new String[0], "", "");
